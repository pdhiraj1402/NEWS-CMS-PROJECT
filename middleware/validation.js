...
const loginValidation = [
    body('username')
        ...
        .withMessage('Username must be 5 to 12 character long'),
...
const userValidation = [
    body('fullname')
        ...
        .isLength({min:5, max:10})
        .withMessage('Fullname must be 5 to 10 character long'),
    ...
    body('username')
        ...
        .withMessage('Username must not contain spaces')
        .isLength({min:5, max:12})
        .withMessage('Username must be 5 to 10 character long'),
